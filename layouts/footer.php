                ...
                <ul class="footer-menu">
                        ...
                        <ul class="footer-menu__submenu footer-submenu">
                            ...
                            <li class="footer-submenu__item">
                                <a class="no-style footer-submenu__item-link"
                                   href="<?=DATA['domain']?>/windows">Пластиковые окна
                                    KBE</a>
                            </li>

                            <li class="footer-submenu__item">
                                <a class="no-style footer-submenu__item-link"
                                   href="<?=DATA['domain']?>/windows">Пластиковые
                                    окна Veka</a>
                            </li>
                            <li class="footer-submenu__item">
                                <a class="no-style footer-submenu__item-link"
                            ...
                            <li class="footer-menu__item">
                                <a class="no-style footer-menu__item-link"
                                   href="/plastikovyye-dveri-s-ustanovkoy/">Пластиковые
                                    двери</a>
                            </li>
                            <li class="footer-submenu__item">
                                <a class="no-style footer-submenu__item-link"
                    ...
                    <li class="footer-menu__item">
                        ...
                        <ul class="footer-menu__submenu footer-submenu">
                            <li class="footer-submenu__item">
                                <a class="no-style footer-submenu__item-link"
                                   href="<?=DATA['domain']?>lodgii">Теплое остекление
                                    балкона</a>
                            </li>

                            <li class="footer-submenu__item">
                                <a class="no-style footer-submenu__item-link"
                                   href="<?=DATA['domain']?>lodgii">Холодное остекление
                                    балкона</a>
                            </li>

                            <li class="footer-submenu__item">
                                <a class="no-style footer-submenu__item-link"
                                   href="<?=DATA['domain']?>lodgii">Панорамное
                                    остекление балкона</a>
                            </li>
                            <li class="footer-submenu__item">
                                <a class="no-style footer-submenu__item-link"
                                   href="<?=DATA['domain']?>lodgii">Отделка и утепление балкона</a>
                            </li>
