                        ...
                        <div class="mob-mega-menu__submenu mob-mg-submenu js-mg-submenu">
                            <div class="mob-mg-submenu__head">
                                ...
                                <a href="/plastikovye-okna-s-ustanovkoy-pod-klyuch/"
                                   class="no-style mob-mg-submenu__head-label"> Пластиковые Окна
                                </a>
                            </div>
                            <ul class="mob-mg-submenu__list">
                                <li class="mob-mg-submenu__item js-mob-mg-item"><a
                                            href="<?=DATA['domain']?>/windows/"
                                            class="no-style mob-mg-item">
                                        <div class="mob-mg-item__label">KBE</div>
                                    </a></li>
                                <li class="mob-mg-submenu__item js-mob-mg-item"><a
                                            href="<?=DATA['domain']?>/windows/"
                                            class="no-style mob-mg-item">
                                        <div class="mob-mg-item__label">Veka</div>
                                    </a></li>
                                <li class="mob-mg-submenu__item js-mob-mg-item"><a
                                            href="<?=DATA['domain']?>/windows/"
                                            class="no-style mob-mg-item">
                                        <div class="mob-mg-item__label">Ivaper</div>
                                    </a></li>
                                <li class="mob-mg-submenu__item js-mob-mg-item"><a
                                            href="<?=DATA['domain']?>/windows/"
                                            class="no-style mob-mg-item">
                                        <div class="mob-mg-item__label">Melke</div>
                                    </a></li>
                            </ul>
                        </div>
                    </li>
...
<!--                            </div>-->
                            <ul class="mob-mg-submenu__list">
                                ...
                                <li class="mob-mg-submenu__item js-mob-mg-item"><a
                                            href="{{$domain}}/services" class="no-style mob-mg-item">
                                        <div class="mob-mg-item__label">Монтаж окон</div>
                                    </a></li>
                                <li class="mob-mg-submenu__item js-mob-mg-item"><a href="{{$domain}}/aksessuary/"
                                                                                   class="no-style mob-mg-item">
...
<!--                        </a></li>-->
                    ...
                    <li class="mob-mega-menu__item js-mob-mg-item"><a href="{{$domain}}/contacts/" class="no-style mob-mg-item">
