<section class="main-banner main-banner--fullpage main-banner--dark js-main-banner">
    ...
    <div class="main-banner-bg main-banner-bg--animation-scale">
        <img src="<?=IMG?>header_hero/cottage_hero_header.webp" alt="Остекление балконов и лоджий в Вологде" decoding="async" width="2560" height="1440">
    </div>
    <div class="inner-container main-banner__container">
        <h1 class="h1 main-banner__head-title">Остекление<br> котеджей и дач в Вологде</h1>
