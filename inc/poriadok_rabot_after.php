    ...
    <div class="free-meas-form__info">
        ...
        <div class="free-meas-form__info-item">
            <div class="free-meas-form__info-ico">
                <svg class="ico">
                    <use xlink:href="<?=IMG?>free-meas-form.svg#manager-person"></use>
                </svg>
            </div>
        ...
        <div class="free-meas-form__info-item">
            <div class="free-meas-form__info-ico">
                <svg class="ico">
                    <use xlink:href="<?=IMG?>free-meas-form.svg#calculator"></use>
                </svg>
            </div>
        ...
        <div class="free-meas-form__info-item">
            <div class="free-meas-form__info-ico">
                <svg class="ico">
                    <use xlink:href="<?=IMG?>free-meas-form.svg#box-pack"></use>
                </svg>
            </div>
        ...
        <div class="free-meas-form__info-item">
            <div class="free-meas-form__info-ico">
                <svg class="ico">
                    <use xlink:href="<?=IMG?>free-meas-form.svg#delivery-time"></use>
                </svg>
            </div>
        ...
        <div class="free-meas-form__info-item">
            <div class="free-meas-form__info-ico">
                <svg class="ico">
                    <use xlink:href="<?=IMG?>free-meas-form.svg#smile"></use>
                </svg>
            </div>
